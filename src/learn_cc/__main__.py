...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"\033[36m║  learn-cc v{__version__}                                    ║\033[0m")
    print(f"\033[36m║  模型: {config.model:37s}║\033[0m")
    print(f"\033[36m║  目录: {str(config.workdir)[:36]:36s}║\033[0m")
    print(f"\033[36m║  输入指令，回车发送  |  q 退出                    ║\033[0m")
    print(f"\033[36m╚══════════════════════════════════════════════════╝\033[0m\n")
